...
public:
    ...
    std::function< bool (const fw::ID& sessionid, const std::vector<int32_t>& datapieces)>FunctionDoSendDataRequest;


    std::function< bool (uint32_t piecesnum)>FunctionDoRequestDatapiecesTask;
